...
let
  sources = {
    ...
    "color-4.2.1" = {
      ...
      version = "4.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/color/-/color-4.2.1.tgz";
...
in
{
  ...
  "@napi-rs/cli" = nodeEnv.buildNodePackage {
    ...
    version = "2.5.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@napi-rs/cli/-/cli-2.5.0.tgz";
      sha512 = "OstHFxgQaGFgir0XfvHLstpxhYY+YLafUKQSyAAAIW8QerlgmijDnZa0Oka7QkdYbVEPw6mFCuxu7JiPYF+SYw==";
    };
    buildInputs = globalBuildInputs;
    meta = {
  ...
  sharp = nodeEnv.buildNodePackage {
    ...
    version = "0.30.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/sharp/-/sharp-0.30.3.tgz";
      sha512 = "rjpfJFK58ZOFSG8sxYSo3/JQb4ej095HjXp9X7gVu7gEn1aqSG8TCW29h/Rr31+PXrFADo1H/vKfw0uhMQWFtg==";
    };
    dependencies = [
      sources."ansi-regex-2.1.1"
  ...
  bcrypt = nodeEnv.buildNodePackage {
    name = "bcrypt";
    packageName = "bcrypt";
    version = "5.0.1";
    src = fetchurl {
